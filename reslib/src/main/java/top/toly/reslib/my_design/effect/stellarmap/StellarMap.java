...
public class StellarMap extends FrameLayout implements AnimationListener, OnTouchListener, OnGestureListener {
    ...
    public StellarMap(Context context, AttributeSet attrs) {
        ...
        TypedArray t = context.obtainStyledAttributes(attrs, R.styleable.StellarMap);
        mXRegularity = t.getInteger(R.styleable.StellarMap_XRegularity, 5);
        mYRegularity = t.getInteger(R.styleable.StellarMap_YRegularity, 2);
    ...
    private void init() {
        ...
        mHidenGroup.setRegularity(mXRegularity, mYRegularity);
        mShownGroup.setRegularity(mXRegularity, mYRegularity);
