...
import top.toly.zutils.core.ui.common.DwUtils;
 ...
 */
public class BlockTextView extends android.support.v7.widget.AppCompatEditText {
    ...
    private void init() {
        ...
        rightDrawable = getResources().getDrawable(R.drawable.block_et_exit_pressed);
        drawablePadding = Change.dp2px(getContext(), 10);
        itemPadding = Change.dp2px(getContext(), 3);
...
//            int spansStringLength = getSpansStringLength(spans);
    ...
    private void generateOneSpan(Spannable spannableString, UnSpanText unSpanText) {
        ...
        BitmapDrawable bitmpaDrawable = (BitmapDrawable) DwUtils.convertViewToDrawable(spanView);
...
//            System.out.println("start:"+start+";end:"+end);
    ...
    private BitmapDrawable drawImageSpan(int measuredWidth, String spanText) {
        ...
        textPaint.setTextSize(Change.dp2px(getContext(),(int) getTextSize()));
        textPaint.getTextBounds(spanText, 0, spanText.length(), textRect);
        int textPadding = Change.dp2px(getContext(),6);
        ...
        Drawable background = getResources().getDrawable(R.drawable.block_et_bulk_bg);
    ...
    public View getSpanView(Context context, String text, int maxWidth) {
        ...
        view.setBackgroundResource(R.drawable.block_et_bulk_bg);
