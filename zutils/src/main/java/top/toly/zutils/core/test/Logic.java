package top.toly.zutils.core.test;
...
public class Logic {
     ...
     * @return 两点间夹角
     */
    public static float angleOf2Pos(PointF p0, PointF p1) {
     ...
     * @return 中点
     */
    public static PointF getMiddlePos(PointF p1, PointF p2) {
     ...
     * @return 交点
     */
    public static PointF[] getCrossOfCircle$Line(PointF center, float radius, Double k) {
